    ...
    def render(self):
        ...
        for y, map in self.maps:
            if 1020 >= y >= 20:
                ...
                drawing_text(title, 510, y + 10, font_color=pygame.Color(80, 80, 80), font_size=30)
                drawing_text(artist, 510, y + 35, font_color=pygame.Color(100, 100, 100), font_size=20)
                drawing_text(version, 510, y + 55, font_color=pygame.Color(0, 0, 0), font_size=30)
