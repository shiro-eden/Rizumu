...
[Как открыть?]
На данный момент(26.12.2020) игра открывается через файл main.py вместе со всеми файлами в проекте.
...
Если игрок пропустил ноту, то она засчитывается за промах.
