...
character_ability = (('Во время игры заряжается способность. При её',
                      'активации на некоторое время все оценки "Miss"',
                      ' и "Bad" станут "Perfect"'),

                     ('Во время игры заряжается способность. При её',
                      'активации на некоторое время все ноты будут',
                      ' уничтожены и дадут оценку "Great" '),

                     ('Во ввремя игры комбо не будет сбрасываться,',
                      'если вы пропустили ноту и комбо меньше 100'),

                     ('Во время игры заряжается способность. При',
